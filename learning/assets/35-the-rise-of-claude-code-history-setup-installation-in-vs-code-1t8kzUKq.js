var e=`# The Rise of Claude Code History, Setup & Installation in VS Code
...
- And in September 2025, I mean, obviously during 2025, it then took off massively. September brought V2, which brought this whole robust ecosystem. Many of these features have be...
- It was check pointing, sub-agents, hooks, skills, background tasks. There's also a Claude Code SDK that lets you write code to use the kind of Claude Code ecosystem. It's not th...
- The Cloud Code SDK is for working within the Cloud Code ecosystem. Now, at this time, the best model on the planet from Anthropic was Claude Sonnet 4.5, which is one of the best...
...
- And coming after that, Gemini 3 Pro, Google's-top model, seen as in the similar camp and codecs 5.2, GPT 5.2 codecs from OpenAI that we've been working with, is also at that tie...

## You will learn

- Core ideas from **The Rise of Claude Code History, Setup & Installation in VS Code**
