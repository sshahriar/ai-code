...
- Along our journey together, I've mentioned a few times there's a technique called SDD spec driven design. And SDD is is about having plugins or tools or processes which walks th...
- There are some more formal ones that go through a more rigorous process. And there was a time when that was a big deal with Cloud Code, and it seems to be less so now, 'cause it...
- There is now a new thing that's come up, not that new anymore, but pretty new, which is seen as a sort of natural evolution of spec-driven design, which is spec-driven design co...
...
- Core ideas from **GSD Spec-Driven Design Meets Multi-Agent Orchestration**
