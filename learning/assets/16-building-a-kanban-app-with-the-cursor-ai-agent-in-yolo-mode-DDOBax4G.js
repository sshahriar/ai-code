...
- All right, and now over here, in the agent dropdown, I want you to select plan. That means that we're putting the agent into planning mode. And this is going to be, I think cons...
...
- I don't need to tell you what it's planning because it will load agents.md into context, always by default, and you can see stuff is happening, it's reading, it's thinking, thin...
- How much of the context window has been consumed by the thinking so far. And you can see that 6.4% has been used. It also mentions that the active rules, the things that it's lo...

## You will learn

- Core ideas from **Building a Kanban App with the Cursor AI Agent in YOLO Mode**
