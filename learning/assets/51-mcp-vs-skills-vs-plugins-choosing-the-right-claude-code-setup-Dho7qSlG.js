var e=`# MCP vs Skills vs Plugins Choosing the Right Claude Code Setup
...
- That is that is exciting. Okay, it's time for us to put put one of them to the test. Okay, we're going to try and run our code simplifier to simplify everything and you can dire...
...
- Core ideas from **MCP vs Skills vs Plugins Choosing the Right Claude Code Setup**
