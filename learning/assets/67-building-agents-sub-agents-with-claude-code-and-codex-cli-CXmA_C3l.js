...
- If you wrote these, if you kicked off these three as three separate agents running, I think that probably a fiasco would emerge. I just think there's not enough substance on how...
- So there will be tremendous confusion. So there's not enough kind of fabric in place for us to just kick off three different agents. But it gives you a sense of what it means an...
- But I'm actually gonna take this down a different direction, which is totally optional. You can do everything I'm about to do using Cloud Code. But I thought I'd shake it up a b...
...
- We are going to use codecs as a CLI. The equivalent that OpenAI has to Cloud Code, which is how codecs began. So I'm going to quickly install it now and show you how we can use...

## You will learn

- Core ideas from **Building Agents & Sub-Agents with Claude Code and Codex CLI**
