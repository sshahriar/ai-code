var e=`# Connecting Claude Code to Jira MCP Server & GitHub Repository
...
- But here we are and we're about to add an mcp server to our cloud code. So I'm going to paste in here a command, Claude mcp add. And I'm going to say, you'd say, adding an MCP s...
...
- Okay, so first up, I'm going to do slash mcp to check out our situation with mcp servers. It tells us that we've got Atlassian as an installed mcp server, Atlassian, the makers...
- So that we're going into it. It says need authentication, not authenticated. Do you want to authenticate?

## You will learn

- Core ideas from **Connecting Claude Code to Jira MCP Server & GitHub Repository**
