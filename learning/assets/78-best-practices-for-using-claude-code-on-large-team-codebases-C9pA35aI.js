var e=`# Best Practices for Using Claude Code on Large Team Codebases
...
- We're basically talking about focusing on the top half of those kind of six ways of doing things on the yellow, on the 2025 techniques more than the purple 2026 crazy techniques...
- It reflects what an agent would need to know in order to work within this directory, this folder, without having to read all the files. So it should be like really a good, tight...
- That is the trick and it takes time and effort. You can get, of course, Cloud Code to write this for you, but then you need to eyeball it and make sure you're satisfied with it....
- Invest time in your agents.md, it will pay dividends. And also, project documentation for agents is what it's all about. If you have a document that you tag with the @ sign, the...
- Better is to describe what a document does and then put a link to it because then Claude Code or the other coding agent can decide does it need to know about this document and i...

## You will learn

- Core ideas from **Best Practices for Using Claude Code on Large Team Codebases**
