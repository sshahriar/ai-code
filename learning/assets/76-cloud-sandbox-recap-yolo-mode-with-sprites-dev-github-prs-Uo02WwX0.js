...
- And that didn't work because we're not logged in to GitHub here and it told me you have to log in to GitHub with GH auth login, something that we just covered, I think, yesterda...
- I did GH auth login and it spawned a window on my computer, even though we're in the cloud, I logged into GitHub and then we were logged into GitHub. I then typed "claud" to go...
- And sure enough, it made, it already made a branch, it then pushed that branch to GitHub, and it told me it's created a pull request, and this is now ready for my review on GitH...
...
- Core ideas from **Cloud Sandbox Recap YOLO Mode with Sprites.dev & GitHub PRs**
