var e=`# YOLO Mode Choosing the Right LLM for Agentic Coding in IDEs
...
- You sort of think that cursor's the name of the company as well, but it's not. And cursor itself is what they call a fork of VS code, which means that VS code is actually open s...
- So we didn't, it isn't a fork of VS code, it's a VS code with an extension loaded in to get you, give you GitHub co-pilot in the agent chat screen. That's what we did. And after...
- And again, there are different ways to use codex one of the ways, perhaps not the most common way actually but by the way we did it is to use it as an extension in VS code just...

## You will learn

- Core ideas from **YOLO Mode Choosing the Right LLM for Agentic Coding in IDEs**
