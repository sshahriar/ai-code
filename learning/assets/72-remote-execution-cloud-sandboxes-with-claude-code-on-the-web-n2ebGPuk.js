var e=`# Remote Execution & Cloud Sandboxes with Claude Code on the Web
...
- It happens in a sandbox world, which is why it's kind of all related to sandboxing. And it allows you also, in this crazy way, to do work on the move. And when I say that, what...
- And it's going off and doing it on the internet, in the cloud, in some way, and it's coming back and telling you something and you're continuing your conversation. And when you...
...
- Core ideas from **Remote Execution & Cloud Sandboxes with Claude Code on the Web**
