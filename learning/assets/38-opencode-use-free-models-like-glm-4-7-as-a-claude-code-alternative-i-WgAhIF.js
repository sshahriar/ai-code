var e=`# OpenCode Use Free Models Like GLM 4.7 as a Claude Code Alternative
...
- And you should have your way to install it for your system. There's also of course, as usual docs here, which has the introductory stuff and the way to install it. And you can i...
- Here are the Windows instructions. If you've got a Choco, then that's the easy way to do it, but otherwise MPM of course, 'cause we already installed Node, so that gives you a r...
- Just the basic way for the Mac. We'll go and do that right now, copy that to the clipboard, and we'll go and do that right now, copy that to the clipboard, and we'll go and do i...
- By the way, in Cloud, you could just press Escape to get out of that status screen and then Command Control C to close Cloud Code, and then close down the project, bring up our...
- We'll go back into PM again. Here we are in our favorite project. You may be already have this open.

## You will learn

- Core ideas from **OpenCode Use Free Models Like GLM 4.7 as a Claude Code Alternative**
