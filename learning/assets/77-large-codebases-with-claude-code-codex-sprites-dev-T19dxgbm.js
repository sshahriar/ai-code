var e=`# Large Codebases with Claude Code, Codex & Sprites.dev
...
- We're not up for a boring day like that. I can cover that material quite quickly. And then, and then, I've got some spicy topics, some spicy things to throw into the mix to keep...
- So prepare yourself, be prepared for some spice. Let's get through the large cobay to work place, some good stuff, some vegetables to get through first, and then we will bring o...
- Now I'm gonna start with another recap, and I realize this is like the third day in a row of recapping the same material, but I feel like I gave you a lot to digest on the first...
- And before we get to the spicy stuff, if I'm not carrying this too much, it's worth us taking one more moment to look at this. Slash commands, we know, include code or how you r...
- And skills of course consistent across Cloud Code and codecs, and I think everyone is really jumping on the skills bandwagon to a large extent, they're kind of taking over from...

## You will learn

- Core ideas from **Large Codebases with Claude Code, Codex & Sprites.dev**
