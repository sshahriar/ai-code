var e=`# MCP Servers Explained Hosts, Clients, and Discovery for Claude Code

> Quick summary | Week 2 | Day 3
...
- The MCP host, the MCP client, the MCP server. The MCP host is the name of the overall AI application, which is running, which needs to call tools. And so, Cloud Code is an examp...
- Chat GPT is an MCP host. If you're writing your own agentic app like we do in my agentic track of my AI engineer course, we use open AI agent sstk and that as an application, th...
- The mcp client is a bit of code that runs within the mcp host where there's one of them for each of the sets of tools that you're using. And that is, again, that is something th...
- And that is the thing that manages the set of tools written by somebody else. So what they give you is an MCP server, an MCP server for browsing the internet, an MCP server for...

## You will learn

- Core ideas from **MCP Servers Explained Hosts, Clients, and Discovery for Claude Code**
- Practical steps shown in Week 2, Day 3
