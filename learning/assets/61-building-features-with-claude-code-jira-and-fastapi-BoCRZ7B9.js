...
- Let's see what happens. Okay, it's come back and ask me questions like before. The first one it's saying is that for this V1 foundational ticket, should authentication be functi...
...
- For the front and back end integration, should the current NDA form functionality remain client-side or should the form data be safe, persisted to the back end? Let's keep it cl...
- That's the end of our questions. Off it goes. Back to thinking.

## You will learn

- Core ideas from **Building Features with Claude Code, Jira, and FastAPI**
