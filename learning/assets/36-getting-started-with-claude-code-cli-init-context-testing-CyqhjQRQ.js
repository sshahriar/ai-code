var e=`# Getting Started with Claude Code CLI Init, Context & Testing
...
- I don't remember that, I'm not sure whether I just did something wrong when I tried to accept the changes. But anyway, that's a good problem for us to have right now. As you wil...
- This is Control Backtick again, and it is time now within PM for us to launch Claude Code. But actually first, let me just do a git status to see what this looks like. I haven't...
...
- So the first thing I'm gonna ask you to do is actually exit the terminal by typing exit and then open a new terminal just to make sure it's absolutely new. You can also do this...

## You will learn

- Core ideas from **Getting Started with Claude Code CLI Init, Context & Testing**
