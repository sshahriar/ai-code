...
- The optimal workflow with coding agents has changed consistently with what I just described with the different school of thought between the two years. Let me take you through w...
- At the lowest level of trust where we began is micromanagement and this is where you would use an agent but you, when I see you, I mean me, this is definitely was my mode for mo...
- And then the next step was taking a bit of a step back, a bit more trust. Now, a lot of these programs, a lot of these coding agents have a planning mode. You can put them on pl...
- And when they're on plan mode, they produce documentation like sort of to-do lists of what's going to happen. And you're working together on figuring out the plan for what's to...
- And so that idea of planning first, and then executing, and typically you execute in phases. And for each phase, I would have it go off and build something, then I would do a co...

## You will learn

- Core ideas from **The Evolution of AI Coding Workflows From YOLO to Ralph Loops**
