# Skills vs MCP Claude Code's Simpler Way to Add Abilities
...
- Just the very first part of it does, which has some information about when is the rest of it relevant. And the LLM just gets to decide, does it want to load in the rest or not?...
- And when it loads in the rest, it loads in the rest of the document. But also there are other documents that it could, even more optionally, load in, should it wish to. So it ca...

## You will learn

- Core ideas from **Skills vs MCP Claude Code's Simpler Way to Add Abilities**
