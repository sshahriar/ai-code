...
- Agents.md, I've mentioned it several times. This, of course, is the file which you use to give to prep your LLM with some information it's particularly it's used by coding agent...
- It was it's sort of inspired by by thinking of a way that we could have something that could represent an HTML page, a web page with a sort of simpler, more human readable and w...
...
- It's like a text file with some useful extra characters to show like a mark up, styling. And this is a format which LLM's love. They love markdown because they've been trained w...
- They've generated lots of Markdown, so they just love making Markdown files and they love reading them and they're easy to write as well. So it makes absolute sense that we woul...

## You will learn

- Core ideas from **Mastering agents.md Context Window Strategy for Coding Agents**
