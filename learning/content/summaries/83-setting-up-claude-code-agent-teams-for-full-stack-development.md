# Setting Up Claude Code Agent Teams for Full-Stack Development
...
- That's good because we want to keep everything as vanilla, as simple as possible. .github contains the actions, if we wanted to tag Claude, that's fine, we're not going to be do...
- I also want to go into Claude and find out what kind of plugins we have enabled, what MCP we have enabled. We want to make sure that everything is nice and vanilla Because we do...
...
- Core ideas from **Setting Up Claude Code Agent Teams for Full-Stack Development**
