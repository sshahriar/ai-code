# Adding MCP Servers to Claude Code Context7 & Polygon IO
...
- Now for this one to work, you have to get an API key, which is free if you don't mind having like stale market data. But the, you, you, I've got an API key and in my agent of co...
- So I am going to show you this too, but more for amusement of showing how you can give so many different kinds of skills. But it's not obviously not a great example for helping...
...
- Core ideas from **Adding MCP Servers to Claude Code Context7 & Polygon IO**
