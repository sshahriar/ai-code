# Building a Kanban App with Codex Debugging Drag and Drop
...
- So it's interesting, it's, I had thought it would store everything as a JSON blob, so it could be easily provided. But this is possibly a better design. Maybe I might not perhap...
...
- We will see, I'll let it do part six and I'll see you in a sec. Okay, well I confirmed part six finished and then I checked it, nothing is broken, it hasn't yet wired up, the fr...
- Again, I'm going to do a git status. I'm going to do a git add git commit minus m part six done. Okay, so we've taken our git checkpoint and now we come over here and say procee...

## You will learn

- Core ideas from **Building a Kanban App with Codex Debugging Drag and Drop**
