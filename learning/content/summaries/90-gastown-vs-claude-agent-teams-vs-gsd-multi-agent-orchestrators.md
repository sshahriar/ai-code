...
- And I'll mention again that we should give it some credit because it's really starting from absolute nothing. The other times we've had a build using the market data foundation...
- So it's a total build from absolute scratch. That's what it had to do. And it did it all massively parallel.

## You will learn

- Core ideas from **Gastown vs Claude Agent Teams vs GSD Multi-Agent Orchestrators**
