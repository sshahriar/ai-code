...
- We've been doing stuff this week that's been using front end code. And I realized you might not even have the sort of context of, okay, so I'm sure you've heard terms like front...
- What does that mean? How does it work? Let me quickly explain.
- So put simply, the projects we'll be working on in this course are what they call web applications, meaning that you use a browser to access them. And it's very common for web a...
- And obviously the front end is the stuff that runs in the user's web browser. It runs within Chrome or Safari or Microsoft Edge or whatever. And it's typically got some combinat...
- And then obviously the backend as you probably know is something which is running on a server. It's perhaps the thing that served up the web page in the first place, the HTML an...

## You will learn

- Core ideas from **Web Apps 101 Front-End, Back-End, APIs & Docker Setup**
