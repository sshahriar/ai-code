...
- And there's something comforting about knowing that we've got a completely fresh chat, so the context window is empty, but it's not completely empty because it's got the agents...

## You will learn

- Core ideas from **AI Assistant Kanban App Complete Codex, OpenRouter & Week 1 Wrap**
