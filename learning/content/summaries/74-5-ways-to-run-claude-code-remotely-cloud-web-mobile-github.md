# 5 Ways to Run Claude Code Remotely Cloud, Web, Mobile & GitHub

> Quick summary | Week 3 | Day 2
...
- You can put an ampersand before it and then that same thing will not run on your computer, but it will spawn, anthropic in the cloud and run it and get you back the answer. But...
- It's not able to do it right now, which is too bad and running slash login doesn't do anything. But it will work for you and more than that, you could put in any instruction you...
- And once you've done that, you can do slash tasks and you'll see a list of what else is running out there. And that's pretty cool. And yeah, these are all unfortunately I've got...
- Just as you could, press plus and have lots of them running on your own box. But it doesn't need to be on your box, it can be out there on the cloud running in a little sandbox...
- And I should mention that the work that's happening on the cloud, when you kick it off, the full context of the conversation so far is sent off to the cloud. So it can continue...

## You will learn

- Core ideas from **5 Ways to Run Claude Code Remotely Cloud, Web, Mobile & GitHub**
- Practical steps shown in Week 3, Day 2
