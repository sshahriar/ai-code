...
- Let's create a new website one off it goes, let's create a new card here. And this is going to be prototype of NDA creator, of mutual NDA creator. And that's what it's gonna be...
- Let's create that, let's come into it, look at the details, we are going to now approach this as if it's a real business requirement, something we want to do, maybe this has bee...
- It is a web application to create a mutual NDA document for a user. The user enters some key information in a form. The website then displays the mutual NDA enters some key info...
...
- As you might hear from a customer, I'm not saying what format it gets downloaded. I'm going to leave all this kind of detail up to cloud code. This is the Jira issued called pro...

## You will learn

- Core ideas from **Claude Code Builds a Full Next.js App from a Jira Ticket**
